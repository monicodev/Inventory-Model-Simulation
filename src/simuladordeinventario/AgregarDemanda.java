...
public class AgregarDemanda extends javax.swing.JFrame {

    File archivo = null;

    public AgregarDemanda() {
        initComponents();
        this.setResizable(false);
        this.setLocationRelativeTo(this);
        this.setTitle("Agregar demanda");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Agregar Demanda");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {            
            if(Integer.parseInt(jTextField1.getText())<=0 || Double.parseDouble(jTextField2.getText())<=0){
                ...
                list.addElement("Demanda: " + Integer.parseInt(jTextField1.getText())
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for (int i=0; i < list.getSize(); i++){
           listaDemanda.add( new ListaDeProbabilidad(
                    Integer.parseInt(list.getElementAt(i).toString().substring(9,list.getElementAt(i).toString().indexOf(","))),
                        ...
                        if (confirmation != JFileChooser.APPROVE_OPTION){
                            ...
                            try {
                                ...
                                for (int i=0; i<listaDemanda.size();i++){
                                    PW.println(listaDemanda.get(i).indicador +";"+listaDemanda.get(i).probabilidad);
                                }
                                FW.close();
                                PW.close();
                            } catch (IOException ex) {
                                Logger.getLogger(AgregarDemanda.class.getName()).log(Level.SEVERE, null, ex);
                            }
                        }
                    }
                    this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarDemanda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
