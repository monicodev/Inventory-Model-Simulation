...
public class AgregarTiempoDeEspera extends javax.swing.JFrame {

    File archivo = null;

    public AgregarTiempoDeEspera() {
        initComponents();
        this.setResizable(false);
        this.setLocationRelativeTo(this);
        this.setTitle("Agregar tiempo de espera");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Agregar Tiempo de espera");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if(Integer.parseInt(jTextField1.getText())<0 || Double.parseDouble(jTextField2.getText())<=0){
                ...
                list.addElement("Tiempo De Espera: " + Integer.parseInt(jTextField1.getText())
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for (int i=0; i < list.getSize(); i++){
           listaTiempoDeEspera.add( new ListaDeProbabilidad(
                    Integer.parseInt(list.getElementAt(i).toString().substring(18,list.getElementAt(i).toString().indexOf(","))),
                        ...
                        if (confirmation != JFileChooser.APPROVE_OPTION){
                            ...
                            try {
                                ...
                                for (int i=0; i<listaTiempoDeEspera.size();i++){
                                    PW.println(listaTiempoDeEspera.get(i).indicador +";"+listaTiempoDeEspera.get(i).probabilidad);
                                }
                                FW.close();
                                PW.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarTiempoDeEspera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
